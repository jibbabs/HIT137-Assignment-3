...
pygame.display.set_caption("JOHN JONES: CITY DEFENDER")
...
class Player(pygame.sprite.Sprite):
    ...
    def update(self, pressed_keys, pressed_mouse):
        ...
        self.rect = (self.x - 5 ,self.y + 20 ,self.width-24,self.height - 20)
...
class levelLoad():  
    ...
    def levelOne(self):
        ...
        robotEnemy2 = level_Data.enemy('enemyA', 900, SCREEN_HEIGHT - 150, 0, 20, 30, 20, 600, 800) 
...
def drawGame():
    ...
    #for enemies in currentLevel.enemyList:
           #enemy_group.add(currentLevel.enemyList[enemies]) 
